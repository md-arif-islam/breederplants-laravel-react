...
<head>
    ...
    <title>Sample Date Notification</title>
</head>
                ...
                <table width="100%" cellpadding="0" cellspacing="0" style="max-width: 600px; margin: 0 auto;">
                    ...
                    <tr>
                        <td style="box-sizing: border-box; padding: 20px; border-radius: 3px; background-color: #f6f9fc; box-shadow: 0 2px 8px rgba(0, 0, 0, 0.05);" bgcolor="#f6f9fc">
                            <h1 style="color: #45a049; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; margin: 0 0 20px; font-size: 22px; font-weight: bold; text-align: center;">Sample Date Notification</h1>
                            ...
                            <p style="font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; margin: 0 0 20px; font-size: 14px; color: #000000;">
                                Your next sample date is <strong>{{ $formatted_date ?? '' }}</strong> for the variety: <strong>{{ $variety_name ?? '' }}</strong>.
                            </p>
                            <p style="font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; margin: 0 0 20px; font-size: 14px; color: #000000;">
                                To ensure we continue processing your reports efficiently, please submit your sample on time. You can view the full report by clicking the button below.
                            </p>
                                        ...
                                        <table cellpadding="0" cellspacing="0">
                                            <tr>
                                                <td style="border-radius: 50px; background-color: #45a049;">
                                                    <a href="{{ $url ?? '#' }}" style="font-size: 14px; font-family: Helvetica, Arial, sans-serif; color: #ffffff; text-decoration: none; border-radius: 50px; padding: 10px 20px; border: 1px solid #45a049; display: inline-block; font-weight: bold;" target="_blank">View Report</a>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                            ...
                            <p style="font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; margin: 0 0 20px; font-size: 14px;">
                                <a href="{{ $url ?? '#' }}" style="color: #45a049; text-decoration: none; word-break: break-all;">{{ $url ?? '#' }}</a>
                            </p>
