...
<head>
    ...
    <title>Overdue Sales Report</title>
</head>
                ...
                <table width="100%" cellpadding="0" cellspacing="0" style="max-width: 600px; margin: 0 auto;">
                    ...
                    <tr>
                        <td style="box-sizing: border-box; padding: 20px; border-radius: 3px; background-color: #f6f9fc; box-shadow: 0 2px 8px rgba(0, 0, 0, 0.05);" bgcolor="#f6f9fc">
                            <h1 style="color: #45a049; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; margin: 0 0 20px; font-size: 22px; font-weight: bold; text-align: center;">Overdue Sales Report</h1>
                            <p style="font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; margin: 0 0 20px; font-size: 14px; color: #000000;">Dear {{ $contactPerson ?? 'User' }},</p>
                            <p style="font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; margin: 0 0 20px; font-size: 14px; color: #000000;">
                                We noticed that your sales report for the quarter <strong>{{ $quarter ?? '' }}</strong> is overdue.
                            </p>
                            <p style="font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; margin: 0 0 20px; font-size: 14px; color: #000000;">
                                To ensure we have the most up-to-date information, please submit your report by clicking the button below.
                            </p>
                                        ...
                                        <table cellpadding="0" cellspacing="0">
                                            <tr>
                                                <td style="border-radius: 50px; background-color: #45a049;">
                                                    <a href="{{ $link ?? '#' }}" style="font-size: 14px; font-family: Helvetica, Arial, sans-serif; color: #ffffff; text-decoration: none; border-radius: 50px; padding: 10px 20px; border: 1px solid #45a049; display: inline-block; font-weight: bold;" target="_blank">View Report</a>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
