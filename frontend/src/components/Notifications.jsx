...
const Notifications = () => {
  ...
  useEffect(() => {
    if (authUser && authUser.id) {
      ...
      const channel = echo.private(channelName).notification((notification) => {
        ...
        const normalizedNotification = {
          ...
          data: {
            ...
            variety_report_id: notification.data?.variety_report_id || null,
        ...
        setNotifications((prev) => {
          ...
          console.log("Previous notifications:", previousNotifications);
  ...
  return (
    ...
    <div className="flex flex-row items-center">
      ...
      <div className="notification relative mx-1" ref={dropdownContainerRef}>
                ...
                notifications.map((notification, index) => (
                  <div
                    ...
                    className={`p-2 rounded-md flex text-[#333] justify-between items-center border-b ${
                      notification.read_at ? "bg-white" : "bg-gray-200"
                    }`}>
                    <span
