    ...
    <div className="bg-gray-50 -mt-12">
      <div className="container mx-auto">
        <div className="-mt-12 z-10 relative">
          <div className="relative text-center flex items-center justify-center w-full rounded-t-3xl">
            {!imgLoaded && (
            ...
            <img
              ...
              className={`w-full h-56 md:h-96 object-cover rounded-t-3xl transition-opacity duration-300 ${
                imgLoaded ? "opacity-100" : "opacity-0"
              }`}
            />
          </div>

          <div className="min-h-screen bg-white rounded-t-3xl p-4 md:p-6 -mt-12 z-30 relative ">
            <h2 className="text-xl md:text-2xl font-bold mb-2 lg:mb-6">
              {report?.variety_name}
            </h2>
            <div className="grid grid-cols-2 gap-y-2 p-4 border-b">
              ...
              <span className="text-gray-900 font-semibold text-right text-sm md:text-sm">
                {report?.open_field_trial ? "Yes" : "No"}
              </span>
            </div>
