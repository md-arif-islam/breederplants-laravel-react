          ...
          <div className="p-6">
            <div className="grid gap-4 sm:grid-cols-2">
              <div>
                ...
                <p className="mt-1">{varietySample.sample_date}</p>
              </div>
              <div>
                <h3 className="text-sm font-medium text-gray-500">
                  Leaf Color
                </h3>
                <p className="mt-1">{varietySample.leaf_color}</p>
              </div>
              <div>
                <h3 className="text-sm font-medium text-gray-500">
                  Amount of Branches
                </h3>
                <p className="mt-1">{varietySample.amount_of_branches}</p>
              </div>
              <div>
                <h3 className="text-sm font-medium text-gray-500">
                  Flower Buds
                </h3>
                <p className="mt-1">{varietySample.flower_buds}</p>
              </div>
              <div>
                <h3 className="text-sm font-medium text-gray-500">
                  Branch Color
                </h3>
                <p className="mt-1">{varietySample.branch_color}</p>
              </div>
              <div>
                <h3 className="text-sm font-medium text-gray-500">Roots</h3>
              ...
              <div>
                ...
                <p className="mt-1">{varietySample.flower_color}</p>
              </div>
              <div>
                <h3 className="text-sm font-medium text-gray-500">
                  Flower Petals
                </h3>
                <p className="mt-1">{varietySample.flower_petals}</p>
              </div>
              <div>
                <h3 className="text-sm font-medium text-gray-500">
                  Flowering Time
                </h3>
                <p className="mt-1">{varietySample.flowering_time}</p>
              </div>
              <div>
                <h3 className="text-sm font-medium text-gray-500">
                  Length of Flowering
                </h3>
                <p className="mt-1">{varietySample.length_of_flowering}</p>
              </div>
              <div>
                <h3 className="text-sm font-medium text-gray-500">Seeds</h3>
              ...
              <div>
                ...
                <p className="mt-1">{varietySample.seed_color}</p>
              </div>
              <div>
                <h3 className="text-sm font-medium text-gray-500">
                  Amount of Seeds
                </h3>
                <p className="mt-1">{varietySample.amount_of_seeds}</p>
              </div>
              <div>
                <h3 className="text-sm font-medium text-gray-500">Status</h3>
                <p className="mt-1">
                  {varietySample.status === 0 ? "Inactive" : "Active"}
                </p>
              </div>
            </div>
