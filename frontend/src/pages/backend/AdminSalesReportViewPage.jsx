...
import { Pencil, Trash2, Download, DownloadIcon } from "lucide-react";
              ...
              <div>
                ...
                <p className="mt-1 block w-full px-3 py-2 bg-gray-50 border border-gray-300 rounded-md">
                  {currentSalesReport.submission_date
                    ? format(
                        new Date(currentSalesReport.submission_date),
                        "yyyy-MM-dd HH:mm:ss"
                      )
                    : "Not Submitted"}
                </p>
                ...
                <tbody>
                  {reportData.map((data, index) => (
                    <tr key={index}>
                      ...
                      <td className="px-4 py-2 border-b text-gray-700">
                        {(data.unit_price * data.amount).toFixed(2)}
                      </td>
                    </tr>
                  ))}
                </tbody>
      ...
      {showPopup && (
        <div className="fixed inset-0 flex items-center justify-center bg-gray-100 bg-opacity-75">
          <div className="bg-white p-4 rounded-md shadow-md">
            <p>
              Are you sure you want to delete this sales report? This action
              cannot be undone.
            </p>
