...
const AdminDashboardPage = () => {
  const { isLoading, dashboardStats, getDashboardStats } = useDashboardStore();
            ...
            <div className="flex flex-wrap -mx-6">
              ...
              <div className="w-full px-6 sm:w-1/2 lg:w-1/3 xl:w-1/4 mb-4">
                <div className="flex items-center px-5 py-6 bg-white rounded-md shadow">
                  ...
                  <div className="mx-5">
                    ...
                    <div className="text-gray-500">Growers</div>
                  </div>
                </div>
              </div>
              ...
              <div className="w-full px-6 sm:w-1/2 lg:w-1/3 xl:w-1/4 mb-4">
                <div className="flex items-center px-5 py-6 bg-white rounded-md shadow">
                  ...
                  <div className="mx-5">
                    ...
                    <div className="text-gray-500">Breeders</div>
                  </div>
                </div>
              </div>
              ...
              <div className="w-full px-6 sm:w-1/2 lg:w-1/3 xl:w-1/4 mb-4">
                <div className="flex items-center px-5 py-6 bg-white rounded-md shadow">
                  ...
                  <div className="mx-5">
                    ...
                    <div className="text-gray-500">Variety Reports</div>
                  </div>
                </div>
              </div>
              ...
              <div className="w-full px-6 sm:w-1/2 lg:w-1/3 xl:w-1/4 mb-4">
                <div className="flex items-center px-5 py-6 bg-white rounded-md shadow">
                  ...
                  <div className="mx-5">
                    ...
                    <div className="text-gray-500">Variety Samples</div>
                  </div>
                </div>
              </div>
              ...
              <div className="w-full px-6 sm:w-1/2 lg:w-1/3 xl:w-1/4 mb-4">
                <div className="flex items-center px-5 py-6 bg-white rounded-md shadow">
                  ...
                  <div className="mx-5">
                    ...
                    <div className="text-gray-500">Current Quarter</div>
                  </div>
                </div>
              </div>
              ...
              <div className="w-full px-6 sm:w-1/2 lg:w-1/3 xl:w-1/4 mb-4">
                <div className="flex items-center px-5 py-6 bg-white rounded-md shadow">
                  ...
                  <div className="mx-5">
                    <h4 className="text-2xl font-semibold text-gray-700">
                      {stats.notSubmittedSalesReportCountAtCurrentQuarter || 0}
                    </h4>
                    <div className="text-gray-500">Pending Sales Reports</div>
                  </div>
                </div>
              </div>
              ...
              <div className="w-full px-6 sm:w-1/2 lg:w-1/3 xl:w-1/4 mb-4">
                <div className="flex items-center px-5 py-6 bg-white rounded-md shadow">
                  ...
                  <div className="mx-5">
                    <h4 className="text-2xl font-semibold text-gray-700">
                      {stats.submittedSalesReportCountAtCurrentQuarter || 0}
                    </h4>
                    <div className="text-gray-500">Submitted Sales Reports</div>
                  </div>
                </div>
              </div>
            </div>
