            ...
            <div className="grid gap-6 md:grid-cols-2">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setFormData({ ...formData, cultivar: e.target.value })
                  }
                  className="w-full px-3 py-2 border border-gray-300 rounded-md"
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setFormData({
                      ...formData,
                      cpvo_expiration_date: e.target.value,
                    })
                  }
                  className="w-full px-3 py-2 border border-gray-300 rounded-md"
                />
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setFormData({ ...formData, royalty_fee: e.target.value })
                  }
                  className="w-full px-3 py-2 border border-gray-300 rounded-md"
                />
              </div>
              ...
              <div className="flex items-center space-x-2">
                <input
                  ...
                  onChange={(e) =>
                    setFormData({ ...formData, sun_icon: e.target.checked })
                  }
                  className="h-5 w-5"
                />
                <label htmlFor="sun_icon" className="text-sm font-medium">
                  Sun Icon
                </label>
              </div>
              ...
              <div className="flex items-center space-x-2">
                <input
                  ...
                  onChange={(e) =>
                    setFormData({ ...formData, edible_icon: e.target.checked })
                  }
                  className="h-5 w-5"
                />
                <label htmlFor="edible_icon" className="text-sm font-medium">
                  Edible Icon
                </label>
              </div>
              ...
              <div className="flex items-center space-x-2">
                <input
                  ...
                  onChange={(e) =>
                    setFormData({
                      ...formData,
                      partial_shade_icon: e.target.checked,
                    })
                  }
                  className="h-5 w-5"
                />
              ...
              <div className="flex items-center space-x-2">
                <input
                  ...
                  onChange={(e) =>
                    setFormData({
                      ...formData,
                      blooming_time_icon: e.target.checked,
                    })
                  }
                  className="h-5 w-5"
                />
              ...
              <div className="flex items-center space-x-2">
                <input
                  ...
                  className="h-5 w-5"
                />
                <label htmlFor="pruning_icon" className="text-sm font-medium">
                  Pruning Icon
                </label>
              </div>
              ...
              <div className="flex items-center space-x-2">
                <input
                  ...
                  className="h-5 w-5"
                />
                <label htmlFor="height_icon" className="text-sm font-medium">
                  Height Icon
                </label>
              </div>
              ...
              <div className="flex items-center space-x-2">
                <input
                  ...
                  onChange={(e) =>
                    setFormData({ ...formData, width_icon: e.target.checked })
                  }
                  className="h-5 w-5"
                />
                <label htmlFor="width_icon" className="text-sm font-medium">
                  Width Icon
                </label>
              </div>
