      ...
      <div className="container mx-auto px-4 py-8">
            ...
            <div className="p-6">
              <div className="grid gap-4 sm:grid-cols-2">
                <div>
                  ...
                  <p className="mt-1">{report?.variety_name}</p>
                </div>
                <div>
                  <h3 className="text-sm font-medium text-gray-500">
                    Next Sample Date
                  ...
                  <p className="mt-1">
                    {report && JSON.parse(report.samples_schedule)[0]}
                  </p>
                </div>
                <div>
                  <h3 className="text-sm font-medium text-gray-500">Company</h3>
                  <p className="mt-1">{report?.grower.company_name}</p>
                </div>
                <div>
                  <h3 className="text-sm font-medium text-gray-500">
                    Breeder Name
                  </h3>
                  <p className="mt-1">{report?.breeder.company_name}</p>
                </div>
                <div>
                  <h3 className="text-sm font-medium text-gray-500">
                    Date of Propagation
                  </h3>
                  <p className="mt-1">{report?.date_of_propagation}</p>
                </div>
                <div>
                  <h3 className="text-sm font-medium text-gray-500">
                    Date of Potting
                  </h3>
                  <p className="mt-1">{report?.date_of_potting}</p>
                </div>
                <div>
                  <h3 className="text-sm font-medium text-gray-500">
                    Amount of Plants
                  </h3>
                  <p className="mt-1">{report?.amount_of_plants}</p>
                </div>
                <div>
                  <h3 className="text-sm font-medium text-gray-500">
                    Amount of Samples
              ...
              <div className="grid grid-cols-2 md:flex gap-2 pt-4">
                <button
                  onClick={() => navigate(`/admin/variety-reports/${id}/edit`)}
        ...
        <div className="mt-12">
          <div className="mb-6 flex items-center justify-between">
            <h2 className="text-xl font-semibold">Variety Samples</h2>
            <button
              onClick={() =>
                navigate(`/admin/variety-reports/${id}/variety-sample/create`)
              }
