          ...
          <div className="p-6">
            <div className="grid gap-4 sm:grid-cols-2">
              <div className="space-y-2">
                <h3 className="text-sm font-medium text-gray-500">Genus</h3>
                <p className="mt-1">{currentProduct?.genus}</p>
              </div>
              <div className="space-y-2">
                <h3 className="text-sm font-medium text-gray-500">Species</h3>
                <p className="mt-1">{currentProduct?.species}</p>
              </div>

              <div className="space-y-2">
                <h3 className="text-sm font-medium text-gray-500">Cultivar</h3>
                <p className="mt-1">{currentProduct?.cultivar}</p>
              </div>
              <div className="space-y-2">
                <h3 className="text-sm font-medium text-gray-500">Plant ID</h3>
                <p className="mt-1">{currentProduct?.plant_id}</p>
              </div>
              <div className="space-y-2">
                <h3 className="text-sm font-medium text-gray-500">
                  Protection Number
                </h3>
                <p className="mt-1">{currentProduct?.protection_number}</p>
              </div>
              <div className="space-y-2">
                <h3 className="text-sm font-medium text-gray-500">
                  CPVO Expiration Date
                </h3>
                <p className="mt-1">{currentProduct?.cpvo_expiration_date}</p>
              </div>
              <div className="space-y-2">
                <h3 className="text-sm font-medium text-gray-500">
                  Royalty Fee
                </h3>
                <p className="mt-1">{currentProduct?.royalty_fee}</p>
              </div>
              <div className="space-y-2">
                <h3 className="text-sm font-medium text-gray-500">
                  Blooming Period
                </h3>
                <p className="mt-1">{currentProduct?.blooming_period}</p>
              </div>
              <div className="space-y-2">
                <h3 className="text-sm font-medium text-gray-500">
                  Pruning Period
                </h3>
                <p className="mt-1">{currentProduct?.pruning_period}</p>
              </div>
              <div className="space-y-2">
                <h3 className="text-sm font-medium text-gray-500">
                  Temperature
                </h3>
                <p className="mt-1">{currentProduct?.temperature}</p>
              </div>
              <div className="space-y-2">
