        ...
        <div className="rounded-md border bg-white">
          <div className="overflow-x-auto">
            <table className="w-full table-auto shadow rounded overflow-hidden">
              ...
              <tbody>
                {isLoading && <tr></tr>}
                {!isLoading && growerProducts?.length === 0 && (
                  <tr>
                ...
                {growerProducts?.map((product) => (
                  <tr key={product.id} className="hover:bg-gray-50">
                    <td className="px-4 py-5 text-primary font-medium border-b">
                      {product.product.genus} {product.product.cultivar}
                    </td>
                    ...
                    <td className="px-4 py-2 text-[#353535] border-b ">
                      <div className="flex gap-2">
                        <button
                          ...
                          onClick={() => openAddQuantityModal(product)}>
            ...
            <div className="bg-white rounded-lg shadow-lg w-full max-w-md mx-4">
              <div className="p-6">
                <div className="flex justify-between items-center mb-6">
                  <h2 className="text-xl font-semibold">Add Grower Product</h2>
                  <button
                      ...
                      <select
                        ...
                        {products?.map((product) => (
                          <option key={product.id} value={product.id}>
                            {product.genus} {product.cultivar}
                          </option>
                        ))}
                      </select>
                    </div>
        ...
        {showEditModal && (
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div className="bg-white rounded-lg shadow-lg w-full max-w-md mx-4">
              <div className="p-6">
                <div className="flex justify-between items-center mb-6">
                  <h2 className="text-xl font-semibold">Edit Grower Product</h2>
                  <button
        ...
        {showAddQuantityModal && (
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div className="bg-white rounded-lg shadow-lg w-full max-w-md mx-4">
              <div className="p-6">
                <div className="flex justify-between items-center mb-6">
                  <h2 className="text-xl font-semibold">Add Quantity</h2>
                  <button
