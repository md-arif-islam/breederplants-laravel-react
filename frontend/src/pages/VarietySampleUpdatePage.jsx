...
export default function VarietySampleUpdatePage() {
  ...
  useEffect(() => {
    if (varietySample) {
      ...
      const resolvedImages = images.map((img) =>
        img.startsWith("data:") ? img : `${import.meta.env.VITE_API_URL}/${img}`
      );
      setFormData((prev) => ({
        ...prev,
        sample_date: varietySample.sample_date || "",
        leaf_color: varietySample.leaf_color || "",
        amount_of_branches: varietySample.amount_of_branches?.toString() || "",
        ...
        amount_of_seeds: varietySample.amount_of_seeds?.toString() || "",
        status: varietySample.status?.toString() || "1",
        note: varietySample.note || "",
        images: images, // Stores the raw image data from the API
      }));
      setImagePreviews(resolvedImages);
    }
  }, [varietySample]);
  ...
  const handleSubmit = async (e) => {
    ...
    const response = await updateUserVarietySample(id, sampleId, formData);
    if (response.status === 200) {
      navigate(`/variety-reports/${id}/variety-sample/${sampleId}`);
    }
  };
                ...
                <div className="space-y-2 lg:space-y-4">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={(e) =>
                        setFormData({ ...formData, leaf_color: e.target.value })
                      }
                      className="mt-1 w-full px-2 py-1 md:px-3 md:py-2 bg-gray-50 border border-gray-300 rounded-md text-sm md:text-sm">
                      ...
                      <option value="variegated_white">Variegated White</option>
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={(e) =>
                        setFormData({
                          ...formData,
                          amount_of_branches: e.target.value,
                        })
                      }
                      className="mt-1 w-full px-2 py-1 md:px-3 md:py-2 bg-gray-50 border border-gray-300 rounded-md text-sm md:text-sm">
                      <option value="">Select Amount of Branches</option>
                      {[...Array(10)].map((_, i) => (
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className="mt-1 w-full px-2 py-1 md:px-3 md:py-2 bg-gray-50 border border-gray-300 rounded-md text-sm md:text-sm">
                      <option value="">Select Flower Buds</option>
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className="mt-1 w-full px-2 py-1 md:px-3 md:py-2 bg-gray-50 border border-gray-300 rounded-md text-sm md:text-sm">
                      <option value="">Select Branch Color</option>
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={(e) =>
                        setFormData({ ...formData, roots: e.target.value })
                      }
                      className="mt-1 w-full px-2 py-1 md:px-3 md:py-2 bg-gray-50 border border-gray-300 rounded-md text-sm md:text-sm">
                ...
                <div className="space-y-2 lg:space-y-4">
                  <div>
                    ...
                    <select
                      ...
                      className="mt-1 w-full px-2 py-1 md:px-3 md:py-2 bg-gray-50 border border-gray-300 rounded-md text-sm md:text-sm">
                      <option value="">Select Flower Petals</option>
                      {[...Array(99)].map((_, i) => (
                        <option key={i + 1} value={i + 1}>
                          {i + 1}
                        </option>
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className="mt-1 w-full px-2 py-1 md:px-3 md:py-2 bg-gray-50 border border-gray-300 rounded-md text-sm md:text-sm">
                      <option value="">Select Flowering Time</option>
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={(e) =>
                        setFormData({
                          ...formData,
                          length_of_flowering: e.target.value,
                        })
                      }
                      className="mt-1 w-full px-2 py-1 md:px-3 md:py-2 bg-gray-50 border border-gray-300 rounded-md text-sm md:text-sm">
                      <option value="">Select Length of Flowering</option>
                      {[...Array(99)].map((_, i) => (
                        <option key={i + 1} value={i + 1}>
                          {i + 1} week{i + 1 > 1 ? "s" : ""}
                        </option>
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={(e) =>
                        setFormData({ ...formData, seeds: e.target.value })
                      }
                      className="mt-1 w-full px-2 py-1 md:px-3 md:py-2 bg-gray-50 border border-gray-300 rounded-md text-sm md:text-sm">
                      ...
                      <div>
                        ...
                        <select
                          ...
                          onChange={(e) =>
                            setFormData({
                              ...formData,
                              seed_color: e.target.value,
                            })
                          }
                          className="mt-1 w-full px-2 py-1 md:px-3 md:py-2 bg-gray-50 border border-gray-300 rounded-md text-sm md:text-sm">
                          <option value="">Select Seed Color</option>
                          <option value="white">White</option>
                          <option value="brown">Brown</option>
                      ...
                      <div>
                        ...
                        <select
                          ...
                          onChange={(e) =>
                            setFormData({
                              ...formData,
                              amount_of_seeds: e.target.value,
                            })
                          }
                          className="mt-1 w-full px-2 py-1 md:px-3 md:py-2 bg-gray-50 border border-gray-300 rounded-md text-sm md:text-sm">
