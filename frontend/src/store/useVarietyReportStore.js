...
export const useVarietyReportStore = create((set, get) => ({
  ...
  getAllVarietyReports: async (
    ...
    try {
      ...
      const message =
        error?.response?.data?.message || "Error fetching variety reports";
      toast.error(message);
    } finally {
      set({ isLoading: false });
    }
  ...
  getVarietyReportById: async (id) => {
    set({ isLoading: true });
    try {
      const res = await axiosInstance.get(`/api/admin/variety-reports/${id}`);
      ...
      const message =
        error?.response?.data?.message || "Error fetching variety report";
      toast.error(message);
      throw error;
    } finally {
      set({ isLoading: false });
  ...
  getCreateVarietyReport: async () => {
    set({ isLoading: true });
    try {
      const res = await axiosInstance.get("/api/admin/variety-reports/create");
      set({ growers: res.data.growers });
      set({ breeders: res.data.breeders });
    } catch (error) {
      const message =
        error?.response?.data?.message || "Error creating variety report";
      toast.error(message);
      throw error;
    } finally {
      set({ isLoading: false });
  ...
  createVarietyReport: async (data) => {
    set({ isLoading: true });
    try {
      const res = await axiosInstance.post("/api/admin/variety-reports", data);
  ...
  deleteVarietyReport: async (id) => {
    ...
    try {
      ...
      const message =
        error?.response?.data?.message || "Error deleting variety report";
      toast.error(message);
      throw error;
    } finally {
      set({ isLoading: false });
  ...
  importVarietyReport: async (formData) => {
    ...
    try {
      ...
      const message =
        error?.response?.data?.message || "Error importing variety reports";
      toast.error(message);
      throw error;
    } finally {
      set({ isLoading: false });
