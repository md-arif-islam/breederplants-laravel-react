...
export const useStore = create((set, get) => ({
  ...
  sendResetEmail: async (data) => {
    set({ isLoading: true });
    try {
      const res = await axiosInstance.post("/api/send-reset-link-email", data);
  ...
  getGrower: async (id) => {
    ...
    try {
      ...
      const message =
        error?.response?.data?.message || "Error fetching grower details";
      toast.error(message);
    } finally {
      set({ isLoading: false });
    }
  ...
  updateGrower: async (id, payload) => {
    set({ isLoading: true });
    try {
      const res = await axiosInstance.put(`/api/admin/growers/${id}`, payload);
      set({ currentGrower: res.data });
  ...
  getBreeder: async (id) => {
    ...
    try {
      ...
      const message =
        error?.response?.data?.message || "Error fetching breeder details";
      toast.error(message);
    } finally {
      set({ isLoading: false });
    }
  ...
  updateBreeder: async (id, payload) => {
    set({ isLoading: true });
    try {
      const res = await axiosInstance.put(`/api/admin/breeders/${id}`, payload);
      set({ currentBreeder: res.data });
  ...
  createBreeder: async (payload) => {
    set({ isLoading: true });
    try {
      const res = await axiosInstance.post("/api/admin/breeders", payload);
